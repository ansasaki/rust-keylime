...
enum AgentAction {
    ...
    Add {
        ...
        /// Name for the runtime policy in the verifier database
        #[arg(long, value_name = "NAME")]
        runtime_policy_name: Option<String>,

        /// Public key file to verify the runtime policy DSSE signature
        #[arg(long, value_name = "FILE")]
        runtime_policy_sig_key: Option<String>,
